...
function EditForm(props) {
  ...
  const [formDeatils, setFormDetails] = React.useState(props.formData);
    ...
    return (
        ...
        <div>
            <TabPanel value={value} index={0}>
                <QuestionsTab formData={{name: "Testing Form", description: "Creating a testing form"}} />
            </TabPanel>
